...
PhoenixMiner.exe -pool ssl://eu1-etc.ethermine.org:5555 -pool2 ssl://eu1-etc.ethermine.org:5555 -ewal 0x6ff85749ffac2d3a36efa2bc916305433fa93731.azr9tefjykgmpjj -gpow 96 -coin etc
pause
